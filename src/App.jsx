    ...
    <>
      ...
      <div className="shell">
        ...
        <main>
          ...
          {activePanel === 'signal' && <Signal signal={signal} signalAxios={signalAxios} gmailSyncStatus={gmailSyncStatus} signalLandscape={signalLandscape} benchmarks={benchmarks} mockIC={mockIC} />}
